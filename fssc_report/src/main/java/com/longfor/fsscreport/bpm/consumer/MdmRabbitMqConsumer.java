...
import com.longfor.fsscreport.clear.service.IOdsHrEmployeeOrgService;
import com.longfor.fsscreport.clear.service.IOdsHrEmployeeService;
import com.longfor.fsscreport.clear.service.IOdsHrOrgService;
...
@Component
public class MdmRabbitMqConsumer {

    @Autowired
    private IOdsHrEmployeeOrgService employeeOrgService;

    @Autowired
    private IOdsHrEmployeeService employeeService;
    @Autowired
    private IOdsHrOrgService orgService;
    private final Logger log = LoggerFactory.getLogger(getClass());

    @RabbitHandler
    @RabbitListener(queues = RabbitMqConfig.MDM_CALLBACK_QUEUE, containerFactory = "mdmFactory")
