...
public class RemoteCallUtilRPA {
	
	
	private  final     Logger log = LoggerFactory.getLogger(RemoteCallUtilRPA.class);
	...
	public    JSONObject sendSyncRequest(Map<String,Object> map) {
	    ...
	    try {
	        httpConn = (HttpURLConnection) new URL(properties.getProperties("ydgzdj")).openConnection();
