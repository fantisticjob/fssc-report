package com.longfor.fsscreport.nc.entity;
 ...
 * @since 2020-11-17
 */
@TableName("AUXILIARYBALANCE")
public class Auxiliarybalance implements Serializable {
     ...
     * 账簿变啊
     */
    @TableField("ACCOUNTINGBOOKCODES")
    private String accountingbookcodes;
    ...
    public String getAccountingbookcodes() {
        return accountingbookcodes;
    }

    public void setAccountingbookcodes(String accountingbookcodes) {
        this.accountingbookcodes = accountingbookcodes;
    }
    ...
    public String getAccassitemcode() {
        return accassitemcode;
    }

    public void setAccassitemcode(String accassitemcode) {
        this.accassitemcode = accassitemcode;
    }
