...
function createProcess(userCode, processDefName, processInstName, processInstDesc,usearea,usedate) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/bpm/createProcess',
        dataType:'json',
...
function mounthCloseAccountProcess(userCode,id, processDefName, processInstName, processInstDesc,pt,haveNopass) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/bpm/createProcessId',
        dataType:'json',
...
function withdrawalProcess(userCode,instanceId) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/bpm/withdrawalProcess',
        dataType:'json',
...
function getRpaData(codeCr,month) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/dwcalistofmonth/getRpaData',
        dataType:'json',
...
function dwcalistofmonthtaskTimed(uuid){
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/dwcalistofmonth/taskTimed',
        dataType:'json',
        data:{uuid:uuid},
        success: function (res) {
            if (res.status=="200") {
...
function baBalanceProcess(id,month) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/reconciliation/selectStete',
        dataType:'json',
		async:false,//同步
...
function nobaBalanceProcess(rid,month) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/reconciliation/notSelectStete',
        dataType:'json',
 ...
 * protocal+appip+'/fssc_report/reconciliation/lockState'
 */
function  BalanceProcessLockState( status,id,month) {
	var resstatus="";
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/reconciliation/lockState',
        dataType:'json',
		async:false,//同步
...
function BalanceProcesssubmit(id,month) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/reconciliation/submit',
        dataType:'json',
        data:{id:id,month:month},
        success: function (res) {
			//alert(res.status);
...
function BalanceProcessnotsubmit(id,month) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/reconciliation/notSubmit',
        dataType:'json',
        data:{id:id,month:month},
        success: function (res) {
			//alert(res.status);
...
function deleteDataLog(deleteParm) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/reconciliation/copyDetail',
        dataType:'json',
		async:false,//同步
...
function oneTouchTotal(accountsId,month) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/reconciliation/oneTouchTotal',
        dataType:'json',
...
function oneTouchTotalSubmit(accountsId,month) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/reconciliation/oneTouchTotalSubmit',
        dataType:'json',
        data:{accountsId:accountsId,month:month},
        success: function (res) {
...
function getvResults(accountId,month) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/reconciliation/getvResults',
        dataType:'json',
...
function getRpaDataBa(companyName,accountid,yearMonth) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/task/getRpaData',
        dataType:'json',
...
function taskTimed(uuid){
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/task/taskTimed',
        dataType:'json',
        data:{uuid:uuid},
        success: function (res) {
            if (res.status=="200") {
...
function updateStoredProcedure(accountId,month) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/reconciliation/updateStoredProcedure',
        dataType:'json',
        data:{accountId:accountId,month:month},
        success: function (res) {
 ...
 *  余额调节表明细校验
    ...
    protocal+appip+'/fssc_report/reconciliation/preservation'
 */
function preservation( accountId,month) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/reconciliation/preservation',
        dataType:'json',
        data:{accountId:accountId,month:month},
		async:false,//同步
        success: function (res) {
...
function openProcessPage(instanceId) {
	...
	//生产环境bpm提交流程
	var url=protocal+bpmip+'/#/process/processInfo?1=1&systemId='+sysCode+'&instanceId='+instanceId
	 
	//预生产bpm提交流程
	//http://bpm3-pre.longhu.net/#/process/processInfo?instanceId=100000004262091
	//var url='http://'+bpmip+'/#/process/processInfo?instanceId='+instanceId
...
     obj.document.title=obj.document.title+instanceId;
	 ...
	 //window.open(protocal+bpmip+'/#/process/processInfo?1=1&systemId='+sysCode+'&instanceId='+instanceId);
...
function initAdjust( accountId,month,PLAT_NAME,AREA_NAME,ACCOUNTS_ID) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/reconciliation/initAdjust',
        dataType:'json',
		async:false,//同步
        data:{accountId:accountId,month:month},
        success: function (res) {
...
function updataCbtz(company,month,flag) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/costaccount/updataCbtz',
        dataType:'json',
...
function createProcessZjzc(id,userCode,processInstDesc,processInstName,processDefName,dq){
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/bpm/createProcessByZjzc',
        dataType:'json',
...
function updataPayment(companyName,month,flag) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/costaccount/updataPayment',
        dataType:'json',
...
function updataDwCaListOfMonth(company,month) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/dwcalistofmonth/updataDwCaListOfMonth',
        dataType:'json',
...
function manualConfirmation(company,date,fq) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/costaccount/manualConfirmation',
        dataType:'json',
...
function clearsumcreateProcessId(userCode,id, quarter) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/clear/createProcessId',
        dataType:'json',
...
function clearsumwithdrawalProcess(userCode,instanceId) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/clear/withdrawalProcess',
        dataType:'json',
        data:{userCode:userCode,instanceId:instanceId},
        success: function (res) {
            if (res.status=="200") {
...
function clearNumberOfLocks(accountsId,quarter) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/clear/numberOfLocks',
        dataType:'json',
...
clear/getNcDate(String quarter,String accountsId,String subjectCode)
    @date 20201114 @author gxy
 */
function clearsumGetNcDate(syncDateStr,quarter,accountsId) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/clear/getNcDate',
        dataType:'json',
        data:{syncDateStr:syncDateStr,accountsId:accountsId,quarter:quarter},
        success: function (res) {
            if (res.status=="200") {
                alert(res.result);
                //执行当前页面刷新操作 nottest
...
clear/getNcDate(String quarter,String accountsId,String subjectCode)
    @date 20201114 @author gxy
 */
function clearGetNcDate(syncDateStr, quarter,accountsId,subjectCode) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/clear/getNcDate',
        dataType:'json',
        data:{syncDateStr:syncDateStr, accountsId:accountsId,quarter:quarter,subjectCode:subjectCode},
        success: function (res) {
            if (res.status=="200") {
                alert(res.result);
                //执行当前页面刷新操作 nottest
...
function clearnumberOfLocksCancelled(quarter,accountsId,subjectCode) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/clear/numberOfLocksCancelled',
        dataType:'json',
...
function clearinitData(quarter,accountsId,AREA_CODE,PLAT_CODE) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/clear/initData',
        dataType:'json',
        data:{accountsId:accountsId,quarter:quarter},
        success: function (res) {
            if (res.status=="200") {
...
function clearinitData1(quarter,accountsId,AREA_CODE,PLAT_CODE) {
	$.ajax({
		type:'post',
		url: protocal+appip+'/fssc_report/clear/initData1',
		dataType:'json',
		data:{accountsId:accountsId,quarter:quarter},
		success: function (res) {
			if (res.status=="200") {
...
function clearnotClearDetailStatus(uuid) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/clear/notClearDetailStatus',
        dataType:'json',
        data:{uuid:uuid},
        success: function (res) {
            if (res.status=="200") {
...
function clearUpdataClearDetailStatus(ids) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/clear/updataClearDetailStatus',
        dataType:'json',
		async:false,//同步
        data:{ids:ids},
        success: function (res) {
...
/**
 //--@relation：调用发送龙信消息
 //	--interface1：sendLongforMsgConfirm 往来清理龙信发送确认(frjs)
 //		--parm：ids：xxx，xxx,xxx
 clear/sendLongforMsgConfirm(String ids)
 @date 20201114 @author gxy
 */
function sendLongforMsgConfirm(ids) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/clear/sendLongforMsgConfirm',
        dataType:'json',
        async:false,//同步
        data:{ids:ids},
        success: function (res) {
...
function imptaxsourceprocess( userCode,processDefName,month,accountsId) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/bpm/processIdBySources',
        dataType:'json',
...
function takeDataBlendingFlag( selectType,blendingType,id,userCode,selectFlag,month,accountId,datatype) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/reconciliation/takeDataBlendingFlag',
        dataType:'json',
        data:{
...
function takeBlendingUpdate( userCode, operateFlag,month,accountId, updateRes,datatype) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/reconciliation/takeBlendingUpdate',
        dataType:'json',
...
function takeBlendingInit(month,accountId) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/reconciliation/takeBlendingInit',
        dataType:'json',
...
function getRpaDataHz(codeCr, month, dealType, detailKemu,sqlresult,result_name) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/dwcalistofmonth/ydgzTion',
        dataType:'json',
...
function autoTakeBlendingUpdate(month,accountId,userCode) {
    $.ajax({
        type:'post',
        url: protocal + appip + '/fssc_report/reconciliation/autoTakeBlendingUpdate',
        dataType:'json',
...
function clearTakeDataBlendingFlag(selectType, blendingType, id, userCode, selectFlag, month, accountsId, subjectCode) {
    $.ajax({
        type: 'post',
        url: protocal + appip + '/fssc_report/clear/takeDataBlendingFlag',
        dataType: 'json',
        data: {
            selectType: selectType,
            blendingType: blendingType,
...
function ClearTakeBlendingUpdate(userCode, operateFlag, month, accountsId, subjectCode) {
    $.ajax({
        type: 'post',
        url: protocal + appip + '/fssc_report/clear/takeBlendingUpdate',
        dataType: 'json',
...
function clearBlendInit(userCode, operateFlag,month,accountsId, subjectCode) {
    $.ajax({
        type: 'post',
        url: protocal + appip + '/fssc_report/clear/clearBlendInit',
        dataType: 'json',
        data: { userCode:userCode, operateFlag:operateFlag,month: month, accountsId: accountsId,subjectCode:subjectCode },
        success: function (res) {
            if (res.code == "200") {
...
function exportNc() {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/export/exportNc',
        dataType:'json',
        success: function (res) {
			alert("下载成功！");
        },
...
/*var appip='';
//--@relation：进行勾兑
接口：/fssc_report/clear/takeBlendingHigh
quarter：季度
accountsId：账套id
subjectCode：科目
@date 20210707 @author gxy
*/
function ClearTakeBlendingHigh( quarter, accountsId, subjectCode,userCode) {
    $.ajax({
        type: 'post',
        url: protocal + appip + '/fssc_report/clear/takeBlendingHigh',
        dataType: 'json',
        data: { quarter: quarter, accountsId: accountsId, subjectCode: subjectCode ,userCode: userCode},
        success: function (res) {
            if (res.code == "200") {
                alert(res.msg);
            } else {
...
/*var appip='';
//--@relation：取消勾兑
接口：/fssc_report/clear/notTakeBlendingHigh
quarter：季度
accountsId：账套id
subjectCode：科目
@date 20210707 @author gxy
*/
function notTakeBlendingHigh(quarter, accountsId, subjectCode,userCode) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/clear/notTakeBlendingHigh',
        dataType:'json',
        data:{quarter: quarter, accountsId: accountsId, subjectCode: subjectCode ,userCode: userCode},
        success: function (res) {
            if (res.status=="200") {
...
@date 20210707 @author gxy
*/
function sendLongforMsgConfirmCondition(quarter, accountsId, subjectCode,userCode) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/clear/sendLongforMsgConfirmCondition',
        dataType:'json',
        async:false,//同步
        data:{quarter: quarter, accountsId: accountsId, subjectCode: subjectCode,userCode: userCode},
        success: function (res) {
...
/**
 往来清理提交逻辑
 往来清理提交逻辑
 @date 20210617 @author ysliu
 */
function submitClearRecords(quarter,accountsId) {
    $.ajax({
        type:'post',
        url: protocal+appip+'/fssc_report/clear/submitClearRecords',
        dataType:'json',
        data:{quarter:quarter, accountsId:accountsId},
        success: function (res) {
            if (res.status=="200") {
                alert(res.result);
                //执行当前页面刷新操作 nottest
        ...
        error: function () {
            alert('提交异常！请重试！若重试后问题仍未解决，请联系管理员!');
        }
    });
}